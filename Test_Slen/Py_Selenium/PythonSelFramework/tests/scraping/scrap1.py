...
from collections import namedtuple
Station = namedtuple("testtest", ["name", "chipset", "status"])
sta1 = Station("BRCM", 4389, "Active")
sta2 = Station("QCA", 6780, "Inactive")

for sta in [sta1,sta2]:
    print(sta.name,sta.chipset,sta.status)
